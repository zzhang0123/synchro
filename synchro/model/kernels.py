"""Kernel models of the finite joint response (``synchro.model.kernels``).
...
counterpart. :class:`synchro.model.harmonic.HarmonicKernel` is the Dirac-line
...
``synchro.model.phase`` (``tau = 2 (C_SI_M/nu)^2`` in m^2) and excluding the
